...
ifeq ($(UNAME_S),Linux)
LDFLAGS += -L./arm-v7m -ltensorflow-lite -lpthread
endif
ifeq ($(UNAME_S),Darwin)
LDFLAGS += -L./macos-x86-64 -ltensorflow-lite -lcpuinfo -lfarmhash -lfft2d_fftsg -lfft2d_fftsg2d -lruy -lXNNPACK -lpthreadpool -lclog
endif
else
